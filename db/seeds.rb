...
sexy_adventure = Adventure.create!(:title => "#{name}'s Sexy Adventure", :author => name, :guid => SecureRandom.urlsafe_base64(10))
...
psychological_adventure = Adventure.create!(:title => "#{name}'s Psychological Adventure", :author => name, :guid => SecureRandom.urlsafe_base64(10))
...
drunken_adventure = Adventure.create!(:title => "#{name}'s Drunken Adventure", :author => name, :guid => SecureRandom.urlsafe_base64(10))
